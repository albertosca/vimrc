  ...
  let s:guishade0 = "#003333"
  let s:guishade1 = "#1f4f4d"
  let s:guishade2 = "#3d6a67"
  let s:guishade3 = "#5c8681"
  let s:guishade4 = "#7aa19b"
  let s:guishade5 = "#99bdb5"
  let s:guishade6 = "#b7d8cf"
  let s:guishade7 = "#d6f4e9"
  let s:guiaccent0 = "#ff7f57"
  let s:guiaccent1 = "#47ceb5"
  let s:guiaccent2 = "#ffe266"
  let s:guiaccent3 = "#47ceb5"
  let s:guiaccent4 = "#47ceb5"
  let s:guiaccent5 = "#0fa36b"
  let s:guiaccent6 = "#0fea76"
  let s:guiaccent7 = "#0fea76"
  ...
  let s:ctermaccent4 = 80
  let s:ctermaccent5 = 36
  let s:ctermaccent6 = 48
  let s:ctermaccent7 = 48
  ...
  let s:guishade0 = "#dde7e8"
  let s:guishade1 = "#bed5d3"
  let s:guishade2 = "#9ec3bf"
  let s:guishade3 = "#7fb1aa"
  let s:guishade4 = "#609e95"
  let s:guishade5 = "#418c80"
  let s:guishade6 = "#217a6c"
  let s:guishade7 = "#026857"
  let s:guiaccent0 = "#ff7f57"
  let s:guiaccent1 = "#026857"
  let s:guiaccent2 = "#47ceb5"
  let s:guiaccent3 = "#026857"
  let s:guiaccent4 = "#026857"
  let s:guiaccent5 = "#0fa36b"
  let s:guiaccent6 = "#003333"
  let s:guiaccent7 = "#0fa36b"
  let s:ctermshade0 = 254
  let s:ctermshade1 = 15
  let s:ctermshade2 = 152
  let s:ctermshade3 = 247
  let s:ctermshade4 = 109
  let s:ctermshade5 = 73
  let s:ctermshade6 = 66
  let s:ctermshade7 = 30
  let s:ctermaccent0 = 210
  let s:ctermaccent1 = 30
  let s:ctermaccent2 = 80
  let s:ctermaccent3 = 30
  let s:ctermaccent4 = 30
  let s:ctermaccent5 = 36
  let s:ctermaccent6 = 23
  let s:ctermaccent7 = 36
